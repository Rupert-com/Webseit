...
import {
  FILE_Github as Github,
  FILE_Instagram as Instagram,
  FILE_LinkedIn as LinkedIn,
...
const followItems: IfollowItem[] = [
  { picture: Github, link: "https://github.com/Rupert-com" },
  { picture: Instagram, link: "https://www.instagram.com/ru4ert/" },
  {
    picture: LinkedIn,
    link: "https://www.linkedin.com/in/rupert-bogensperger-43707a192/",
  },
];
...
export class Profile_Rupert extends Component<
  IProfile_Rupert,
  IProfile_Rupert_State
> {
  CV() {
    return (
          ...
          {followItems.map((v) => {
            return (
              <Col className="my-2" xs={12} md={12 / followItems.length}>
                ...
                <a
                  href={v.link}
                  className="mx-auto d-flex position-relative"
                  style={{
                    top: -60,
                    height: 70,
                    width: 70,
